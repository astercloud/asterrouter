...
import type { AdminSettings, EmailTemplate, EmailTemplateCatalog, EmailTemplateDetail, LegalDocument, LocaleInfo, PublicSettings, RetentionCleanupResult, SMTPTestConfig } from '@/types'
